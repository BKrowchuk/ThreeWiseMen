...
export const calculatorActions = {
  ...
  saveToLocalStorage() {
    try {
      localStorage.setItem('threeWiseMenCalculators', JSON.stringify(calculatorStore))
    } catch (error) {
  ...
  syncData() {
    ...
    if (calculatorStore.downPayment.monthlyIncome) {
      calculatorStore.cashFlow.income.monthlyIncome = calculatorStore.downPayment.monthlyIncome
      calculatorStore.shared.monthlyIncome = calculatorStore.downPayment.monthlyIncome
    }
    ...
    if (calculatorStore.downPayment.results?.monthlySavingsTarget) {
      calculatorStore.cashFlow.savings.homeFund = calculatorStore.downPayment.results.monthlySavingsTarget
      calculatorStore.shared.homeFundTarget = calculatorStore.downPayment.results.monthlySavingsTarget
    }

    // Sync monthly savings from cash flow calculator
    if (calculatorStore.cashFlow.results?.totalSavings) {
      calculatorStore.shared.monthlySavings = calculatorStore.cashFlow.results.totalSavings
    }
